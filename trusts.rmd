...
In brief, if each MSOA contributes patients to one or more NHS Trusts, and is a member of exactly one LTLA region, then the number of patients that a LTLA region contributes to a NHS Trust, per year, is deducible via appropriate aggregates.  Hence, *the flow weight from a LTLA to a NHS Trust it contributes to, and for a specified year, is*
